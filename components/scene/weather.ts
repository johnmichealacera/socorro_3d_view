...
export interface WeatherConfig {
  ...
  waveMult:    number;    // multiply base PHT wave amplitude
}
...
export const WEATHER: Record<WeatherPreset, WeatherConfig> = {
  sunny: {
    ...
    sunMult: 1.0,  hemiMult: 1.0,  exposure: 1.0,  waveMult: 0.90,
  },
  cloudy: {
    label: "Cloudy",   icon: "⛅",
    raining: false,
    ...
    sunMult: 0.65, hemiMult: 0.80, exposure: 0.85, waveMult: 1.00,
  },
  overcast: {
    label: "Overcast", icon: "☁",
    raining: false,
    ...
    sunMult: 0.35, hemiMult: 0.58, exposure: 0.68, waveMult: 1.20,
  },
  rain: {
    label: "Rain",     icon: "🌧",
    raining: true,
    ...
    sunMult: 0.20, hemiMult: 0.42, exposure: 0.54, waveMult: 1.65,
  },
  storm: {
    label: "Storm",    icon: "⛈",
    raining: true,
    ...
    sunMult: 0.09, hemiMult: 0.28, exposure: 0.38, waveMult: 2.60,
  },
};
